export const SITE_BASE_URL = "https://ireplugin.com";
export const PLUGIN_NAME = "Interactive Real Estate";

export const SITE_TITLE = "WordPress Plugin for Interactive Images";
