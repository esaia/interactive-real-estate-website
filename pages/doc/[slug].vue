...
<template>
  ...
  >
    <div
      class="top-28 flex h-fit min-w-[200px] flex-col gap-2 rounded-md p-3 pl-0 text-gray-800 after:absolute after:right-0 after:top-0 after:h-full after:w-[1px] after:bg-gray-100 lg:sticky lg:w-96"
    >
      <NuxtLink
        v-for="item in data"
        :to="item.path"
    ...
    <div
      v-if="item"
      class="w-full [&_.language-php]:max-w-[600px] [&_h3_a]:no-underline [&_hr]:mb-8 [&_img]:rounded-lg [&_thead]:border-[#e5e7eb]"
    >
